...
class HotelOne_Theme_Color_Customize_Control extends WP_Customize_Control {
public $type = 'new_menu';

       function render_content(){
		   
	   echo '<h3>'._e('Primary Color','hotelone').'</h3>';
		  ...
		  <script>
			jQuery(document).ready(function($) {
				$("#customize-control-theme_color label div").click(function(){
					$("#customize-control-theme_color label div").removeClass("color_active");
...
class HotelOne_Customize_Repeatable_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        ...
        <div class="repeatable-actions">
            <span class="button-secondary add-new-repeat-item"><?php echo ( $this->add_text ) ? esc_html( $this->add_text ) : __( 'Add an item', 'hotelone' ); ?></span>
        </div>
        <?php
    }
            ...
            <div class="widget">
                <div class="widget-top">
                    ...
                    <div class="widget-title">
                        <h4 class="live-title"><?php _e( 'Item', 'hotelone' ); ?></h4>
                    </div>
                </div>
                                ...
                                <# if ( field.type ){ #>
                                    ...
                                    #>
                                        ...
                                        <# } else if ( field.type == 'media' ) { #>
                                            ...
                                            <div class="actions">
                                                <button class="button remove-button " <# if ( ! field.value.url ){ #> style="display:none"; <# } #> type="button"><?php _e( 'Remove', 'hotelone' ) ?></button>
                                                <button class="button upload-button" data-media="{{field.media}}" data-add-txt="<?php esc_attr_e( 'Add', 'hotelone' ); ?>" data-change-txt="<?php esc_attr_e( 'Change', 'hotelone' ); ?>" type="button"><# if ( ! field.value.url  ){ #> <?php _e( 'Add', 'hotelone' ); ?> <# } else { #> <?php _e( 'Change', 'hotelone' ); ?> <# } #> </button>
                            ...
                            <div class="widget-control-actions">
                                <div class="alignleft">
                                    <span class="remove-btn-wrapper">
                                        <a href="#" class="repeat-control-remove" title=""><?php _e( 'Remove', 'hotelone' ); ?></a> |
                                    </span>
                                    <a href="#" class="repeat-control-close"><?php _e( 'Close', 'hotelone' ); ?></a>
                                </div>
                                <br class="clear">
                            </div>
