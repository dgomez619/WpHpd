...
function jewelry_store_customizer_team( $wp_customize ){
	...
	$wp_customize->add_panel( 'team_panel',
		array(
			...
			'title'          => esc_html__( 'Home Page: Team', 'britetechs-companion' ),
			'description'    => '',
		)
	);
		$wp_customize->add_section( 'team_settings' ,
			array(
				'priority'    => 1,
				'title'       => esc_html__( 'Team Settings', 'britetechs-companion' ),
				'description' => '',
				'panel'       => 'team_panel',
			)
		);
		...
		$wp_customize->add_section( 'team_content' ,
			array(
				'priority'    => 2,
				'title'       => esc_html__( 'Team Contents', 'britetechs-companion' ),
				'description' => '',
				'panel'       => 'team_panel',
			)
		);
