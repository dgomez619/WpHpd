...
function jewelry_store_customizer_service( $wp_customize ){
	...
	$wp_customize->add_panel( 'service_panel',
		array(
			...
			'title'          => esc_html__( 'Home Page: Service', 'britetechs-companion' ),
			'description'    => '',
		)
	);
		$wp_customize->add_section( 'service_settings' ,
			array(
				'priority'    => 1,
				'title'       => esc_html__( 'Service Settings', 'britetechs-companion' ),
				'description' => '',
				'panel'       => 'service_panel',
			)
		);
		...
		$wp_customize->add_section( 'service_content' ,
			array(
				'priority'    => 2,
				'title'       => esc_html__( 'Service Contents', 'britetechs-companion' ),
				'description' => '',
				'panel'       => 'service_panel',
			)
		);
